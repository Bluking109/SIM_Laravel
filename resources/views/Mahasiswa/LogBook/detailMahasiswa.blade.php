...
@section('title_mahasiswa', 'Data LogBook')
            ...
            <div class="main-content" style="padding-right:150px;">
                <div class="container">
                    ...
                    <div class="card">
                            ...
                            <div class="card-block">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style='font-weight: bold;' for="addGrup">Departemen/Area Magang<b style="color: red">*</b></label>
                                            <input class="form-control text-box single-line" data-val="true" data-val-required="The mhs_nama field is required." 
                                            id="pin_id" name="kel_departemen" type="text"  value="{{ old('kel_departemen', $mahasiswa->first()->kel_departemen) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label style='font-weight: bold;' for="addIndustri">Kelompok Magang<b style="color: red">*</b></label>
                                            <input class="form-control text-box single-line" data-val="true" data-val-required="The mhs_nama field is required." 
                                            id="pin_id" name="pin_id" type="text"  value="{{ old('kel_nama', $mahasiswa->first()->kel_nama) }}" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card mt-5 ">
                        ...
                        <div class="card-body">
                            <div class="scrollstyle" style="overflow-x: auto;height : 500px;">
                                <table class="table table-striped table-bordered" id="mytable" name="mytable">
                                    <tr>

                                        <th>No</th>
                                        <th>Pekan</th>
                                        <th>Waktu Mulai LogBook</th>
                                        <th>Waktu Selesai LogBook</th>
                                        <th>Status</th>
                                        <th>Aksi</th>
                                        <tbody>
