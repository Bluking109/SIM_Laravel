...
@section('title_admin', 'Detail LaporanPenilaian')
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            id="pin_id" name="pin_id" type="text"  value="{{ old('mhs_id', $penilaian->first()->mhs_id) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control text-box single-line" data-val="true" data-val-required="The mhs_nama field is required." 
                                            id="pin_id" name="pin_id" type="text"  value="{{ old('mhs_nama', $penilaian->first()->mhs_nama) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control text-box single-line" data-val="true" data-val-required="The mhs_nama field is required." 
                                            id="pin_id" name="pin_id" type="text"  value="{{ old('pro_singkatan', $penilaian->first()->pro_singkatan) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control text-box single-line" data-val="true" data-val-required="The mhs_nama field is required." 
                                            id="pin_id" name="pin_id" type="text"  value="{{ old('pin_nama', $penilaian->first()->pin_nama) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control text-box single-line" data-val="true" data-val-required="The mhs_nama field is required." 
                                            id="pin_id" name="pin_id" type="text"  value="{{ old('ipr_nama', $penilaian->first()->ipr_nama) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control text-box single-line" data-val="true" data-val-required="The mhs_nama field is required." 
                                            id="pin_id" name="pin_id" type="text"  value="{{ old('ipr_grup', $penilaian->first()->ipr_grup) }}" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
